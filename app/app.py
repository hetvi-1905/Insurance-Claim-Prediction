...
# @app.route('/')
# def home():
#     return "Insurance Claim Prediction API is Running!"

# @app.route('/predict', methods=['POST'])  # Allow POST
# def pred():
#     try:
...
#         features = np.array([[age, sex, bmi, children, smoker, region, charges]])

#         # Predict using the model
#         prediction = my_model.predict(features)

#         # Return result
#         return jsonify({"insurance_claim": int(prediction[0])})
